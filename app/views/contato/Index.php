                            ...
                            <tbody>  
                             ...
                             <tr>                                
							   ...
							   <td align="center"><?php  echo $contato->nome?></td>
								...
								<td  align="center" class=" mascara-fone"><?php echo $contato->fone?></td>                           											
								<td align="center"><a href="<?php echo URL_BASE ."contato/edit/" .$contato->id_contato?>" class="d-inline-block btn btn-outline-roxo btn-pequeno"><i class="fas fa-edit"></i> Editar</a>                              </td>									
                                <td align="center"><a href="javascript:;" onclick="return excluir(this)" data-entidade ="contato" data-id="<?php echo $contato->id_contato?>" class="d-inline-block btn btn-outline-vermelho btn-pequeno"><i class="fas fa-trash-alt"></i> Excluir</a>                                </td>
