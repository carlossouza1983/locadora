<div class="rows">	
				...
				<div class="p-1">
					...
					<form name="" action="<?php echo URL_BASE . "localizacao/salvar"?>" method="Post">
                    ...
                    <div class="px-2 pt-2">	
						<div class="bg-padrao border radius-4 mt-2 p-3 radius-4">
							<div class="rows">
                                ...
                                <div class="col-2">
                                <label class= "text-label d-block text-branco">Deposito</label>
                            ...
                            <?php foreach($lista as $local ){?>                                    
                             <tr>
                                ...
                                <td align="center"><?php echo $local->localizacao ?></td>
                                  <td align="center"><?php echo $local->deposito ?></td>                               											                                   											
