...
--
-- Host: 127.0.0.1
-- Generation Time: 19-Out-2022 às 20:05
...
CREATE TABLE `aluga` (
  ...
  `id_contato` varchar(30) DEFAULT NULL,
  `id_produto` varchar(30) DEFAULT NULL,
  `datae` date NOT NULL,
  `datad` date NOT NULL,
...
INSERT INTO `aluga` (`id_aluga`, `id_contato`, `id_produto`, `datae`, `datad`, `preco`) VALUES
(1, '2', '146', '2022-10-18', '2022-10-19', '5,00'),
(2, '2', '146', '2022-10-19', '2022-10-19', '5,00'),
(13, '2', '146', '2022-10-25', '2022-10-27', '5,00'),
(28, '3', '146', '2022-10-18', '2022-10-19', '5,00'),
(29, '4', '147', '2022-10-19', '2022-10-20', '5,00'),
(30, '5', '146', '2022-10-19', '2022-10-26', '5,00'),
(31, '4', '146', '2022-10-19', '2022-10-20', ''),
(32, '3', '147', '2022-10-19', '2022-10-20', '');
...
(147, 12, 1, 'O INFILTRADO', 'S', 'S', '', '5.00', 'e44230cf59a77f4788539a01fac9db20.jpg', 'S', 2, 'um filme de ação com muita violência e');
...
--
-- AUTO_INCREMENT for table `aluga`
--
ALTER TABLE `aluga`
  MODIFY `id_aluga` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
